...
@section('title')
<title>Create note | {{ Lang::get('common.title') }}</title>
@stop
@section('meta')
  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12 col-xs-12">
        {{ Form::open(['route' => 'notes.store', 'class' => 'form-horizontal', 'role' => 'form']) }}
          ...
          <div class="form-group{{ ($errors->first('details')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <textarea class="form-control" rows="5" name="details" id="details" placeholder="Details">{{ Input::old('details') }}</textarea>
            </div>
