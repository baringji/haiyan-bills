...
@section('title')
<title>Create bill | {{ Lang::get('common.title') }}</title>
@stop
@section('meta')
  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12 col-xs-12">
        {{ Form::open(['route' => 'bills.store', 'class' => 'form-horizontal', 'role' => 'form']) }}
          <div class="form-group{{ ($errors->first('name')) ? ' has-error' : '' }}">
            <label class="col-xs-12 col-sm-3 col-md-3 control-label" for="name"> Name </label>
            <div class="col-xs-12 col-sm-5">
              <input class="form-control" type="text" name="name" id="name" placeholder="Name" value="{{ Input::old('name') }}" />
            </div>
          ...
          <div class="form-group{{ ($errors->first('due_date')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <div class="input-group">
                <input class="form-control datepicker" type="text" name="due_date" id="due_date" placeholder="Due Date" value="{{ Input::old('due_date') }}" />
          ...
          <div class="form-group{{ ($errors->first('period_start')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <div class="input-group">
                <input class="form-control datepicker" type="text" name="period_start" id="period_start" placeholder="Period Start" value="{{ Input::old('period_start') }}" />
                <div class="input-group-addon">
                  <i class="fa fa-calendar"></i>
                </div>
              </div>
          ...
          <div class="form-group{{ ($errors->first('period_end')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <div class="input-group">
                <input class="form-control datepicker" type="text" name="period_end" id="period_end" placeholder="Period End" value="{{ Input::old('period_end') }}" />
                <div class="input-group-addon">
                  <i class="fa fa-calendar"></i>
                </div>
              </div>
          ...
          <div class="form-group{{ ($errors->first('details')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <textarea class="form-control" name="details" id="details" placeholder="Details">{{ Input::old('details') }}</textarea>
            </div>
