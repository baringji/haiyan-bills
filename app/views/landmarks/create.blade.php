...
@section('title')
<title>Create landmark | {{ Lang::get('common.title') }}</title>
@stop
@section('meta')
  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12 col-xs-12">
        {{ Form::open(['route' => 'landmarks.store', 'class' => 'form-horizontal', 'role' => 'form']) }}
          ...
          <div class="form-group{{ ($errors->first('type')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <input class="form-control" type="text" name="type" id="type" placeholder="Type" value="{{ Input::old('type') }}">
            </div>
