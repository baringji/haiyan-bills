...
@section('title')
<title>Update user | {{ Lang::get('common.title') }}</title>
@stop
@section('meta')
  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12 col-xs-12">
        {{ Form::open(['route' => array('users.update', $user->id), 'method' => 'put', 'class' => 'form-horizontal', 'role' => 'form']) }}
          <div class="form-group{{ ($errors->first('user_type')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <select class="form-control" name="user_type" id="user_type">
                <option value="0"{{ ($user->user_type == 0) ? ' selected="true"' : '' }}> System </option>
                <option value="1"{{ ($user->user_type == 1) ? ' selected="true"' : '' }}> Administrator </option>
                <option value="2"{{ ($user->user_type == 2) ? ' selected="true"' : '' }}> Consumer </option>
              </select>
            </div>
          ...
          <div class="form-group{{ ($errors->first('first_name')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <input class="form-control" type="text" name="first_name" id="first_name" placeholder="First Name" value="{{{ $user->first_name or null }}}" />
            </div>
          ...
          <div class="form-group{{ ($errors->first('last_name')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <input class="form-control" type="text" name="last_name" id="last_name" placeholder="Last Name" value="{{{ $user->last_name or null }}}" />
            </div>
          ...
          <div class="form-group{{ ($errors->first('middle_name')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <input class="form-control" type="text" name="middle_name" id="middle_name" placeholder="Middle Name" value="{{{ $user->middle_name or null }}}" />
            </div>
          ...
          <div class="form-group{{ ($errors->first('email')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <input class="form-control" type="text" name="email" id="email" placeholder="Email" value="{{{ $user->email or null }}}" />
            </div>
          ...
          <div class="form-group{{ ($errors->first('user_name')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <input class="form-control" type="text" name="user_name" id="user_name" placeholder="Username" value="{{{ $user->user_name or null }}}" />
            </div>
          ...
          <div class="form-group{{ ($errors->first('address')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <textarea class="form-control" name="address" id="address" placeholder="Address">{{{ $user->address or null }}}</textarea>
            </div>
          ...
          <div class="form-group{{ ($errors->first('status')) ? ' has-error' : '' }}">
            ...
            <div class="col-xs-12 col-sm-5">
              <select class="form-control" name="status" id="status">
                <option value="A"{{ ($user->status == 'A') ? ' selected="true"' : '' }}> Active </option>
                <option value="I"{{ ($user->status == 'I') ? ' selected="true"' : '' }}> Inactive </option>
              </select>
            </div>
